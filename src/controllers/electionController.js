...
exports.createPost = async (req, res, next) => {
    try {
        ...
        if (!(election.start > Date.now())) {
            throw new AppError('Cannot add a post while election is ongoing or has ended', 400)
        }
...
exports.createCandidate = async (req, res, next) => {
    try {
        ...
        if (!(election.start > Date.now())) {
            throw new AppError('Cannot add a candidate while election is ongoing or has ended', 400)
        }
